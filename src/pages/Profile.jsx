...
function Profile() {
  ...
  const handleSubmit = async (e)=>{
    ...
    try {
      ...
      const res = await fetch(`https://housyy.onrender.com/sp/update/${currentSp._id}`,{
        method: 'POST',
        headers: {
      ...
      const res = await fetch(`https://housyy.onrender.com/user/update/${currentUser._id}`,{
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleDeleteAccount = async()=>{
    try {
      ...
      const res = await fetch(`https://housyy.onrender.com/sp/delete/${currentSp._id}`,{
        method: 'DELETE',
      });
      const data = await res.json();
      if(data.success===false){
      ...
      const res = await fetch(`https://housyy.onrender.com/user/delete/${currentUser._id}`,{
        method: 'DELETE',
      });
      const data = await res.json();
      if(data.success===false){
  ...
  const handleLogout = async()=>{
    try {
      if(currentSp){
        await fetch('https://housyy.onrender.com/auth/logout');
      dispatch(splogOut());
      }else{
        await fetch('https://housyy.onrender.com/auth/logout');
      dispatch(logOut());
